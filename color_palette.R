pal <- function (n, h = c(240, 180), c = c(35, 40, 15), l = c(35, 92
), power = c(0.6, 1.1), gamma = NULL, fixup = TRUE, alpha = 1, 
    palette = NULL, rev = FALSE, register = NULL, ..., h1, h2, 
    c1, c2, l1, l2, p1, p2, cmax, c.) 
{
    if (!is.null(gamma)) 
